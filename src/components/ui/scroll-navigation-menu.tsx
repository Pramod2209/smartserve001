...
import { Menu, X, Home, User, Settings, Mail, Info, Gem } from "lucide-react"
          ...
          <div className="flex items-center justify-between h-16">
            ...
            >
              <Link to="/" className="flex items-center gap-2 group">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-tr from-blue-600 to-indigo-500 shadow-lg shadow-blue-500/30 transition-transform group-hover:rotate-12">
                  <Gem className="h-5 w-5 text-white" />
                </div>
                <span className="text-2xl font-black tracking-tight">
                  <span className="text-foreground">Smart</span>
                  <span className="bg-gradient-to-r from-blue-500 to-indigo-500 bg-clip-text text-transparent">Serve</span>
                </span>
              </Link>
            </motion.div>
